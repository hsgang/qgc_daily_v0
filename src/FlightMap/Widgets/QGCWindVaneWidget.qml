...
/**
 * @file
 *   @brief QGC Compass Widget copied
...
Item {
    ...
    property real _fontSize:            ScreenTools.defaultFontPointSize * _sizeRatio
//    property real _sensorWindDir:       vehicle ? vehicle.sensor.sensorWindDir.rawValue : 0
    property real _sensorWindDir:       _activeVehicle ? _activeVehicle.sensor.sensorWindDir.rawValue : 0
    property real _sensorWindSpd:       vehicle ? vehicle.sensor.sensorWindSpd.rawValue : 0
...
*/
        Image {
            ...
            source:             "/qmlimages/windVaneArrow.svg"
            mipmap:             true
            sourceSize.width:   width
            fillMode:           Image.PreserveAspectFit
            anchors.centerIn:   parent
            transform: Rotation {
                ...
                angle:          isNoseUpLocked()?0:_sensorWindDir
            }
        }
        ...
        QGCColoredImage {
            ...
            transform: Rotation {
                ...
                angle:          isNoseUpLocked()?-_sensorWindDir:0
            }
        }
        ...
        Rectangle {
            ...
            QGCLabel {
                ...
                property string _headingString: vehicle ? _sensorWindDir.toFixed(0) : "OFF"
